...
public class ConsolaArerolinea extends ConsolaBasica
{
    ...
    public void correrAplicacion( )
    {
        try
        {
            ...
            String archivoAerolinea = "aerolinea.json";
            String archivoTiquetes = "tiquetes.json";

            unaAerolinea.cargarAerolinea( "./datos/" + archivoAerolinea, CentralPersistencia.JSON );
            unaAerolinea.cargarTiquetes( "./datos/" + archivoTiquetes, CentralPersistencia.JSON );
        }
